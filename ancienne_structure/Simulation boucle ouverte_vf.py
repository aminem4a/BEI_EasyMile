...
class StrategySmoothOpt(StrategyBase):
    ...
    def allocate(self, c_vehicle: float, rpm: float, cosphi_map: CosphiInterpolator) -> AllocationOutput:
        ...
        # bien définir chaque variable - 1 com par variable
...
# MAIN
# ============================================================================
# plot les cos phi plutôt que les couples, plot séparément avant et arrière
# plot séparément sans opti (répartition uniforme) et avec opti
def main():
